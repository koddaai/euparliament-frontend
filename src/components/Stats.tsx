...
export default function Stats() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Total MEPs */}
        <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6 card-hover">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-slate-500 uppercase tracking-wide">Total MEPs</p>
              <p className="text-4xl font-bold text-slate-900 mt-2">{stats.totalMeps}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6 card-hover">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-slate-500 uppercase tracking-wide">Political Groups</p>
              <p className="text-4xl font-bold text-slate-900 mt-2">{stats.byGroup.length}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6 card-hover">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-slate-500 uppercase tracking-wide">EU Countries</p>
              <p className="text-4xl font-bold text-slate-900 mt-2">{totalCountries}</p>
            </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="h-10 bg-slate-100 rounded-lg overflow-hidden">
                      <div
                        className={`h-full ${colors.bar} rounded-lg transition-all duration-700 ease-out flex items-center justify-end pr-3`}
